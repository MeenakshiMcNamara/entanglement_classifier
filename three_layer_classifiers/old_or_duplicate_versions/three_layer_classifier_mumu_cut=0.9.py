...
#     save_weights = True  # Tells whether to save weights... currently not used
    ...
    file = root_path + "/mumu_modified_root_1.root"   # this is the data root file loaded into the dataloader
    
    model_name = "threeLayerModel_mumu_corrCut_" + str(correlation_cut) # this is the model name. 
