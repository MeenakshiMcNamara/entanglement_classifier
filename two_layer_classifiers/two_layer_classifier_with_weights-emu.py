...
#         print("x" + str(x.type))
    ...
    if epoch % 10 == 0:
        ...
        if small_loss > loss_val:
            small_loss = loss_val
            torch.save(classifier.state_dict(), "../models/two_layers/twoLayerModel_weights_gpu_emu1")
        ...
        if epoch % 50 == 0:
            ...
            np.save("../data/two_layers/twoLayerModel_weights_gpu_emu1_train", train_loss_array)
            np.save("../data/two_layers/twoLayerModel_weights_gpu_emu1_val", val_loss_array)
