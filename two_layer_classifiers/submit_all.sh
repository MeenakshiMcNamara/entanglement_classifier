...
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 ee_top_mttbar_gen_submissions_weighted_drop_0.2_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 ee_top_mttbar_reco_submissions_weighted_drop_0.2_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 ee_top_mttbar_gen_submissions_weighted_drop_0.5_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 ee_top_mttbar_reco_submissions_weighted_drop_0.5_no_qg.sub

sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 mumu_top_mttbar_gen_submissions_weighted_drop_0.2_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 mumu_top_mttbar_reco_submissions_weighted_drop_0.2_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 mumu_top_mttbar_gen_submissions_weighted_drop_0.5_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 mumu_top_mttbar_reco_submissions_weighted_drop_0.5_no_qg.sub

sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 emu_top_mttbar_gen_submissions_weighted_drop_0.2_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 emu_top_mttbar_reco_submissions_weighted_drop_0.2_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 emu_top_mttbar_gen_submissions_weighted_drop_0.5_no_qg.sub
sbatch  -A scholar --nodes=1 --gres=gpu:1 --gpus=1 -t 04:00:00 emu_top_mttbar_reco_submissions_weighted_drop_0.5_no_qg.sub
