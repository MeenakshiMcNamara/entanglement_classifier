...
#         print("x" + str(x.type))
    ...
    if epoch % 10 == 0:
        ...
        if small_loss > loss_val:
            small_loss = loss_val
            torch.save(classifier.state_dict(), "./models/twoLayerModel_gpu_mumu1_short")
        ...
        if epoch % 50 == 0:
            ...
            np.save("./data/twoLayerModel_gpu_mumu1_train_short", train_loss_array)
            np.save("./data/twoLayerModel_gpu_mumu1_validate_short", val_loss_array)
